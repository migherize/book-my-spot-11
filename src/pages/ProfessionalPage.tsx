...
import { fetchProfessionalById, fetchAvailableSlots, type TimeSlot } from "@/lib/api";
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="lg:col-span-2 space-y-6">
              <div className="flex gap-5 items-start">
                <img src={p.photo ?? "/placeholder.svg"} alt={p.name} className="h-24 w-24 rounded-2xl object-cover shrink-0" />
                <div>
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                    <span className="flex items-center gap-1">
                      ...
                      <span className="font-medium text-foreground">{p.rating}</span> ({p.review_count} reseñas)
                    </span>
            ...
            <div className="rounded-xl border border-border bg-card p-5 space-y-5 h-fit sticky top-24">
              ...
              <div className="border-t border-border pt-4">
                ...
                <Button className="w-full" size="lg" disabled={!selectedDate || !selectedTime} onClick={handleBook}>
                  Reservar cita
                </Button>
              </div>
            </div>
